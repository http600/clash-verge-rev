...
pub static APP_ID: &str = "com.getmybestvpn.desktop";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "bestvpn-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "com.getmybestvpn.desktop.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "bestvpn-backup-dev";
